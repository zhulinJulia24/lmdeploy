...
video_models = {
    ...
    'Video-LLaVA-7B-HF':
    partial(VideoLLaVA_HF, model_path='LanguageBind/Video-LLaVA-7B-hf'),  # noqa
    'VideoChat2-HD':
    partial(
        VideoChat2_HD,  # noqa
    ...
    'Chat-UniVi-7B-v1.5':
    partial(Chatunivi, model_path='Chat-UniVi/Chat-UniVi-7B-v1.5'),  # noqa
    'LLaMA-VID-7B':
    partial(LLaMAVID, model_path='YanweiLi/llama-vid-7b-full-224-video-fps-1'),  # noqa
    'Video-ChatGPT':
    partial(VideoChatGPT, model_path='MBZUAI/Video-ChatGPT-7B', dir_root=VideoChatGPT_ROOT),  # noqa
    'PLLaVA-7B':
    partial(PLLaVA, model_path='ermu2001/pllava-7b', dir_root=PLLaVA_ROOT),  # noqa
    'PLLaVA-13B':
    partial(PLLaVA, model_path='ermu2001/pllava-13b', dir_root=PLLaVA_ROOT),  # noqa
    'PLLaVA-34B':
    partial(PLLaVA, model_path='ermu2001/pllava-34b', dir_root=PLLaVA_ROOT),  # noqa
}
...
ungrouped = {
    ...
    'OmniLMM_12B':
    partial(OmniLMM12B, model_path='openbmb/OmniLMM-12B', root=OmniLMM_ROOT),  # noqa
    'MGM_7B':
    partial(Mini_Gemini, model_path='YanweiLi/MGM-7B-HD', root=Mini_Gemini_ROOT),  # noqa
    'Bunny-llama3-8B':
...
api_models = {
    ...
    'GeminiPro1-5':
    partial(Gemini, model='gemini-1.5-pro', temperature=0, retry=10),  # noqa
    'GeminiFlash1-5':
    partial(Gemini, model='gemini-1.5-flash', temperature=0, retry=10),  # noqa
    'GeminiPro1-5-002':
    partial(GPT4V, model='gemini-1.5-pro-002', temperature=0, retry=10),  # noqa
    'GeminiFlash1-5-002':
    partial(GPT4V, model='gemini-1.5-flash-002', temperature=0, retry=10),  # noqa
    'GeminiFlash2-0':
    partial(Gemini, model='gemini-2.0-flash', temperature=0, retry=10),  # noqa
    'GeminiFlashLite2-0':
    partial(Gemini, model='gemini-2.0-flash-lite', temperature=0, retry=10),  # noqa
    'GeminiFlash2-5':
    partial(Gemini, model='gemini-2.5-flash', temperature=0, retry=10),  # noqa
    'GeminiPro2-5':
    partial(Gemini, model='gemini-2.5-pro', temperature=0, retry=10),  # noqa
    ...
    # Claude
    'Claude3V_Opus':
    partial(Claude3V, model='claude-3-opus-20240229', temperature=0, retry=10, verbose=False),  # noqa
    'Claude3V_Sonnet':
    partial(
        Claude3V,  # noqa
    ...
    'Claude4_Opus':
    partial(Claude3V, model='claude-4-opus-20250514', temperature=0, retry=10, verbose=False, timeout=1800),  # noqa
    'Claude4_Sonnet':
    partial(Claude3V, model='claude-4-sonnet-20250514', temperature=0, retry=10, verbose=False, timeout=1800),  # noqa
    # GLM4V
    'GLM4V':
    ...
    'Taichu-VLR-3B':
    partial(TaichuVLRAPI, model='taichu_vlr_3b', url='https://platform.wair.ac.cn/maas/v1/chat/completions'),
    'Taichu-VLR-7B':
    partial(TaichuVLRAPI, model='taichu_vlr_7b', url='https://platform.wair.ac.cn/maas/v1/chat/completions'),
    # doubao_vl
    'DoubaoVL':
    partial(DoubaoVL, model='Doubao-1.5-vision-pro', temperature=0, retry=3, verbose=False),
    'Seed1.5-VL':
    partial(
        DoubaoVL,
    ...
    # Shopee MUG-U
    'MUG-U-7B':
    partial(MUGUAPI, model='MUG-U', temperature=0, retry=10, verbose=False, timeout=300),  # noqa
    # grok
    'grok-vision-beta':
    partial(
        GPT4V,  # noqa
...
minicpm_series = {
    ...
    'MiniCPM-Llama3-V-2_5': partial(MiniCPM_Llama3_V, model_path='openbmb/MiniCPM-Llama3-V-2_5'),  # noqa
...
thyme_series = {'Thyme-7B': partial(Thyme, model_path='Kwai-Keye/Thyme-RL')}  # noqa
...
llava_series = {
    ...
    partial(LLaVA_Next, model_path='llava-hf/llava-v1.6-vicuna-7b-hf'),  # noqa
    'llava_next_vicuna_13b':
    partial(LLaVA_Next, model_path='llava-hf/llava-v1.6-vicuna-13b-hf'),  # noqa
    'llava_next_mistral_7b':
    partial(LLaVA_Next, model_path='llava-hf/llava-v1.6-mistral-7b-hf'),  # noqa
    'llava_next_yi_34b':
    partial(LLaVA_Next, model_path='llava-hf/llava-v1.6-34b-hf'),  # noqa
    'llava_next_llama3':
    partial(LLaVA_Next, model_path='llava-hf/llama3-llava-next-8b-hf'),  # noqa
    'llava_next_72b':
    ...
    'llava_next_qwen_32b':
    partial(LLaVA_Next2, model_path='lmms-lab/llava-next-qwen-32b'),  # noqa
    'llava_next_interleave_7b':
    partial(LLaVA_Next, model_path='llava-hf/llava-interleave-qwen-7b-hf'),  # noqa
    'llava_next_interleave_7b_dpo':
    partial(LLaVA_Next, model_path='llava-hf/llava-interleave-qwen-7b-dpo-hf'),  # noqa
    ...
    partial(
        LLaVA_OneVision_HF,  # noqa
        model_path='llava-hf/llava-onevision-qwen2-0.5b-si-hf'),
    'llava-onevision-qwen2-7b-ov-hf':
    partial(LLaVA_OneVision_HF, model_path='llava-hf/llava-onevision-qwen2-7b-ov-hf'),  # noqa
    'llava-onevision-qwen2-7b-si-hf':
    partial(LLaVA_OneVision_HF, model_path='llava-hf/llava-onevision-qwen2-7b-si-hf'),  # noqa
    'llava_onevision_qwen2_0.5b_si':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-0.5b-si'),  # noqa
    'llava_onevision_qwen2_7b_si':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-7b-si'),  # noqa
    'llava_onevision_qwen2_72b_si':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-72b-si'),  # noqa
    'llava_onevision_qwen2_0.5b_ov':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-0.5b-ov'),  # noqa
    'llava_onevision_qwen2_7b_ov':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-7b-ov'),  # noqa
    'llava_onevision_qwen2_72b_ov':
    partial(LLaVA_OneVision, model_path='lmms-lab/llava-onevision-qwen2-72b-ov-sft'),  # noqa
    'Aquila-VL-2B':
    partial(LLaVA_OneVision, model_path='BAAI/Aquila-VL-2B-llava-qwen'),  # noqa
    'llava_video_qwen2_7b':
    partial(LLaVA_OneVision, model_path='lmms-lab/LLaVA-Video-7B-Qwen2'),  # noqa
    'llava_video_qwen2_72b':
    partial(LLaVA_OneVision, model_path='lmms-lab/LLaVA-Video-72B-Qwen2'),  # noqa
}

varco_vision_series = {
    'varco-vision-hf': partial(LLaVA_OneVision_HF, model_path='NCSOFT/VARCO-VISION-14B-HF'),  # noqa
    'varco-vision-2-1.7b': partial(VarcoVision, model_path='NCSOFT/VARCO-VISION-2.0-1.7B'),  # noqa
    'varco-vision-2-14b': partial(VarcoVision, model_path='NCSOFT/VARCO-VISION-2.0-14B'),  # noqa
}
...
long_vita_series = {
    'Long-VITA-16K': partial(LongVITA, model_path='VITA-MLLM/Long-VITA-16K_HF', max_num_frame=128),  # noqa
    'Long-VITA-128K': partial(LongVITA, model_path='VITA-MLLM/Long-VITA-128K_HF', max_num_frame=256),  # noqa
    'Long-VITA-1M': partial(LongVITA, model_path='VITA-MLLM/Long-VITA-1M_HF', max_num_frame=256),  # noqa
}
...
internvl = {
    'InternVL-Chat-V1-1': partial(InternVLChat, model_path='OpenGVLab/InternVL-Chat-V1-1', version='V1.1'),  # noqa
    'InternVL-Chat-V1-2': partial(InternVLChat, model_path='OpenGVLab/InternVL-Chat-V1-2', version='V1.2'),  # noqa
...
internvl2 = {
    'InternVL2-1B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-1B', version='V2.0'),
    'InternVL2-2B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-2B', version='V2.0'),
    'InternVL2-4B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-4B', version='V2.0'),
    'InternVL2-8B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-8B', version='V2.0'),
    'InternVL2-26B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-26B', version='V2.0'),
    'InternVL2-40B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-40B', version='V2.0'),
    'InternVL2-76B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-Llama3-76B', version='V2.0'),
    'InternVL2-8B-MPO':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2-8B-MPO', version='V2.0'),
...
internvl2_5 = {
    'InternVL2_5-1B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-1B', version='V2.0'),
    'InternVL2_5-2B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-2B', version='V2.0'),
    'QTuneVL1-2B':
    partial(InternVLChat, model_path='hanchaow/QTuneVL1-2B', version='V2.0'),
    'InternVL2_5-4B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-4B', version='V2.0'),
    'InternVL2_5-8B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-8B', version='V2.0'),
    'InternVL2_5-26B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-26B', version='V2.0'),
    'InternVL2_5-38B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-38B', version='V2.0'),
    'InternVL2_5-78B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL2_5-78B', version='V2.0'),
...
internvl3_5 = {
    'InternVL3_5-1B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-1B', version='V2.0'),
    'InternVL3_5-2B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-2B', version='V2.0'),
    'InternVL3_5-4B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-4B', version='V2.0'),
    'InternVL3_5-8B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-8B', version='V2.0'),
    'InternVL3_5-14B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-14B', version='V2.0'),
    'InternVL3_5-GPT-OSS-20B-A4B-Preview':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-GPT-OSS-20B-A4B-Preview', version='V2.0'),
    'InternVL3_5-30B-A3B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-30B-A3B', version='V2.0'),
    'InternVL3_5-38B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-38B', version='V2.0'),
    'InternVL3_5-241B-A28B':
    partial(InternVLChat, model_path='OpenGVLab/InternVL3_5-241B-A28B', version='V2.0'),
    'InternVL3_5-1B-Thinking':
    partial(InternVLChat,
...
sail_series = {
    'SAIL-VL-2B':
    partial(SailVL, model_path='BytedanceDouyinContent/SAIL-VL-2B'),
    'SAIL-VL-1.5-2B':
    partial(SailVL, model_path='BytedanceDouyinContent/SAIL-VL-1d5-2B', use_msac=True),
    'SAIL-VL-1.5-8B':
    partial(SailVL, model_path='BytedanceDouyinContent/SAIL-VL-1d5-8B', use_msac=True),
    'SAIL-VL-1.6-8B':
    partial(SailVL, model_path='BytedanceDouyinContent/SAIL-VL-1d6-8B', use_msac=True),
...
xcomposer_series = {
    ...
    'XComposer2_1.8b': partial(XComposer2, model_path='internlm/internlm-xcomposer2-vl-1_8b'),  # noqa
    'XComposer2_4KHD': partial(XComposer2_4KHD, model_path='internlm/internlm-xcomposer2-4khd-7b'),  # noqa
    'XComposer2d5': partial(XComposer2d5, model_path='internlm/internlm-xcomposer2d5-7b'),  # noqa
}
...
idefics_series = {
    'idefics_9b_instruct': partial(IDEFICS, model_path='HuggingFaceM4/idefics-9b-instruct'),  # noqa
    'idefics_80b_instruct': partial(IDEFICS, model_path='HuggingFaceM4/idefics-80b-instruct'),  # noqa
    'idefics2_8b': partial(IDEFICS2, model_path='HuggingFaceM4/idefics2-8b'),  # noqa
    # Idefics3 follows Idefics2 Pattern
    'Idefics3-8B-Llama3': partial(IDEFICS2, model_path='HuggingFaceM4/Idefics3-8B-Llama3'),  # noqa
}
...
smolvlm_series = {
    ...
    'SmolVLM2-256M': partial(SmolVLM2, model_path='HuggingFaceTB/SmolVLM2-256M-Video-Instruct'),  # noqa
    'SmolVLM2-500M': partial(SmolVLM2, model_path='HuggingFaceTB/SmolVLM2-500M-Video-Instruct'),  # noqa
...
deepseekvl_series = {
    ...
    'deepseek_vl_1.3b': partial(DeepSeekVL, model_path='deepseek-ai/deepseek-vl-1.3b-chat'),  # noqa
}

deepseekvl2_series = {
    'deepseek_vl2_tiny': partial(DeepSeekVL2, model_path='deepseek-ai/deepseek-vl2-tiny'),  # noqa
    'deepseek_vl2_small': partial(DeepSeekVL2, model_path='deepseek-ai/deepseek-vl2-small'),  # noqa
...
cogvlm_series = {
    ...
    'cogvlm-chat':
    partial(CogVlm, model_path='THUDM/cogvlm-chat-hf', tokenizer_name='lmsys/vicuna-7b-v1.5'),  # noqa
    'cogvlm2-llama3-chat-19B':
    partial(CogVlm, model_path='THUDM/cogvlm2-llama3-chat-19B'),  # noqa
    'glm-4v-9b':
    partial(GLM4v, model_path='THUDM/glm-4v-9b'),  # noqa
    'GLM4_1VThinking-9b':
    partial(GLMThinking, model_path='THUDM/GLM-4.1V-9B-Thinking'),  # noqa
    'GLM4_5V':
    partial(GLMThinking, model_path='THUDM/GLM-4.5V'),
}
...
ovis_series = {
    ...
    'Ovis1.6-Gemma2-27B': partial(Ovis1_6_Plus, model_path='AIDC-AI/Ovis1.6-Gemma2-27B'),  # noqa
...
mantis_series = {
    'Mantis-8B-siglip-llama3': partial(Mantis, model_path='TIGER-Lab/Mantis-8B-siglip-llama3'),  # noqa
    'Mantis-8B-clip-llama3': partial(Mantis, model_path='TIGER-Lab/Mantis-8B-clip-llama3'),  # noqa
...
phi3_series = {
    'Phi-3-Vision': partial(Phi3Vision, model_path='microsoft/Phi-3-vision-128k-instruct'),  # noqa
...
xgen_mm_series = {
    ...
    partial(XGenMM, model_path='Salesforce/xgen-mm-phi3-mini-instruct-dpo-r-v1.5'),
}
...
llama_series = {
    ...
    partial(llama_vision, model_path='meta-llama/Llama-3.2-11B-Vision-Instruct'),  # noqa
    'LLaVA-CoT':
    partial(llama_vision, model_path='Xkev/Llama-3.2V-11B-cot'),  # noqa
    'Llama-3.2-90B-Vision-Instruct':
    partial(llama_vision, model_path='meta-llama/Llama-3.2-90B-Vision-Instruct'),  # noqa
    'Llama-4-Scout-17B-16E-Instruct':
    partial(llama4, model_path='meta-llama/Llama-4-Scout-17B-16E-Instruct', use_vllm=True),  # noqa
}
...
kosmos_series = {'Kosmos2': partial(Kosmos2, model_path='microsoft/kosmos-2-patch14-224')}  # noqa

points_series = {
    'POINTS-Yi-1.5-9B-Chat': partial(POINTS, model_path='WePOINTS/POINTS-Yi-1-5-9B-Chat'),  # noqa
    'POINTS-Qwen-2.5-7B-Chat': partial(POINTS, model_path='WePOINTS/POINTS-Qwen-2-5-7B-Chat'),  # noqa
    'POINTSV15-Qwen-2.5-7B-Chat': partial(POINTSV15, model_path='WePOINTS/POINTS-1-5-Qwen-2-5-7B-Chat'),  # noqa
}
...
h2ovl_series = {
    ...
    'h2ovl-mississippi-1b': partial(H2OVLChat, model_path='h2oai/h2ovl-mississippi-800m'),  # noqa
}

valley_series = {
    'valley2': partial(Valley2Chat, model_path='bytedance-research/Valley-Eagle-7B'),  # noqa
    'valley2_dpo': partial(Valley2Chat, model_path='bytedance-research/Valley2-DPO'),  # noqa
    'valley3': partial(Valley3Chat, use_gthinker_thinking=True, model_path='bytedance-research/Valley3'),  # noqa
}
...
gemma_series = {
    'paligemma-3b-mix-448': partial(PaliGemma, model_path='google/paligemma-3b-mix-448'),  # noqa
...
flash_vl = {'Flash-VL-2B-Dynamic-ISS': partial(FlashVL, model_path='FlashVL/FlashVL-2B-Dynamic-ISS')}  # noqa
...
qtunevl_series = {
    'QTuneVL1_5-2B':
    partial(QTuneVLChat, model_path='hanchaow/QTuneVL1_5-2B', version='V1.5'),  # noqa
    'QTuneVL1_5-3B':
    partial(
        QTuneVL,  # noqa
...
cosmos_series = {
    ...
    'Keye-VL-1.5-8B-auto': partial(KeyeChat, model_path='Kwai-Keye/Keye-VL-1_5-8B'),  # noqa F405
    'Keye-VL-1.5-8B-think': partial(KeyeChat, model_path='Kwai-Keye/Keye-VL-1_5-8B', think=True),  # noqa F405
    'Keye-VL-1.5-8B-nothink': partial(KeyeChat, model_path='Kwai-Keye/Keye-VL-1_5-8B', no_think=True),  # noqa F405
    'Keye-VL-8B-Preview-think': partial(KeyeChat, model_path='Kwai-Keye/Keye-VL-8B-Preview', think=True),  # noqa F405
}

qianfanvl_series = {
    'Qianfan-VL-3B': partial(Qianfan_VL, model_path='baidu/Qianfan-VL-3B'),  # noqa F405
    'Qianfan-VL-8B': partial(Qianfan_VL, model_path='baidu/Qianfan-VL-8B'),  # noqa F405
    'Qianfan-VL-70B': partial(Qianfan_VL, model_path='baidu/Qianfan-VL-70B'),  # noqa F405
}
...
model_groups = [
    ...
    keye_series, qianfanvl_series, lfm2vl_series, rbdashmm_api_series_lmdeploy, interns1_series
]
